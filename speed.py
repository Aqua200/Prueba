...
def shell():
    ...
    printer('*馃敪 Testing From %(isp)s...*\n' % speedtest.config['client'],
            quiet)

    if not args.mini:
        printer('馃搼 Retrieving speedtest.net server list...', quiet)
        try:
        ...
        if args.server and len(args.server) == 1:
            printer('馃摪 Retrieving information for the selected server...', quiet)
        else:
            printer('馃攷 Selecci贸n del mejor servidor basado en ping...', quiet)
    ...
    printer('\n...................................................................................\n馃彫 *Hosted By :* %(sponsor)s\n馃寧 *Ubicaci贸n :* %(name)s [%(d)0.2f km] '
            '\n馃煝 *Ping :* %(latency)s ms' % results.server, quiet)
    ...
    if args.download:
        ...
        printer('*馃摣 Descarga:* %0.2f M%s/s' %
    ...
    if args.upload:
        speedtest.upload()
        printer('*馃殌 Subida:* %0.2f M%s/s' %
                ((results.upload / 1000.0 / 1000.0) / args.units[1],
                 args.units[0]),
                quiet)
        printer("\n...................................................................................\n鈻讹笌 POWERED BY *OOKLA*\n鈻讹笌 Script By *FG98*")
    else:
    ...
    if args.share and not machine_format:
        printer('鈻讹笌Compartir resultado: %s' % results.share())
